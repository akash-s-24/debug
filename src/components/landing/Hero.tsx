...
export function Hero() {
  return (
    <section className="relative min-h-screen pt-32 pb-20 overflow-hidden bg-void flex flex-col items-center">
      ...
      <div className="absolute top-[-20%] left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-[#3b82f6]/15 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute top-[20%] left-[20%] w-[500px] h-[400px] bg-[#6366f1]/15 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-[10%] right-[15%] w-[400px] h-[400px] bg-[#0d9488]/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      >
        ...
        <motion.div variants={itemVariants} className="max-w-4xl">
          <h1 className="text-5xl sm:text-7xl lg:text-8xl font-display font-medium tracking-tighter text-[#F8FAFC] leading-[1.1]">
            Code faster.<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3b82f6] via-[#6366f1] to-[#0d9488] italic font-normal">Competitive Debugging.</span>
          </h1>
        </motion.div>
        ...
        >
          ...
          <Button variant="secondary" size="lg" className="w-full sm:w-auto px-8 h-12 border border-[#3b82f6] text-[#3b82f6] hover:bg-[#3b82f6]/10 font-mono font-bold tracking-wider bg-transparent shadow-none">
            JOIN_BATTLE
          </Button>
        </motion.div>
        ...
        >
          <div className="w-full rounded-xl border border-[#121214] bg-[#121214] shadow-2xl overflow-hidden font-mono text-left shadow-emerald-950/20">
            {/* Terminal Header */}
            <div className="h-10 border-b border-[#121214] flex items-center justify-between px-4 bg-black/40 text-xs">
            ...
            <div className="p-6 text-xs sm:text-sm space-y-2.5 leading-relaxed overflow-x-auto">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#3b82f6] ml-auto font-semibold">[mod_docker_v2]</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[#10B981]">ok ·</span>
                <span className="text-slate-400">Loading Babel AST Error Injector & Hint Engine...</span>
                <span className="text-[#3b82f6] ml-auto font-semibold">[mod_ast_mutator]</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[#10B981]">ok ·</span>
                <span className="text-slate-400">Pusher presence-room signaling established (2ms latency)...</span>
                <span className="text-[#3b82f6] ml-auto font-semibold">[mod_pusher_ws]</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[#10B981]">ok ·</span>
                <span className="text-slate-400">Upstash Redis session state synchronized...</span>
                <span className="text-[#3b82f6] ml-auto font-semibold">[mod_redis_store]</span>
              </div>
              <div className="pt-2 border-t border-[#121214]/60 flex items-center gap-2">
