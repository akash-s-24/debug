...
export function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 grid grid-cols-[auto_1fr_auto] items-center px-6 py-3 bg-[#070709]/95 backdrop-blur border-b border-white/[0.08] text-xs tracking-wider">
      ...
      <div className="fixed top-[48px] left-0 right-0 z-40 flex justify-between items-center px-6 py-1.5 text-[10px] tracking-[0.08em] uppercase text-slate-500 border-b border-white/[0.05] bg-[#070709]/95 backdrop-blur font-mono">
