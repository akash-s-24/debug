...
export function ScoreBoard({ contestants, showDetails = true }: ScoreBoardProps) {
  ...
  return (
    <Card className="w-full flex flex-col p-4 border border-white/10">
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex flex-col items-start">
          <span className="text-blue-500 font-bold text-lg">{p1.user.name}</span>
        ...
        <div className="flex flex-col items-end">
          <span className="text-purple-500 font-bold text-lg">{p2.user.name}</span>
    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="flex gap-1 h-1.5 w-full">
        <div className="flex-1 bg-surface rounded-l-full flex justify-end overflow-hidden">
          <div className="h-full bg-blue-500" style={{ width: w1 }} />
        </div>
        <div className="flex-1 bg-surface rounded-r-full flex justify-start overflow-hidden">
          <div className="h-full bg-purple-500" style={{ width: w2 }} />
        </div>
      </div>
    </div>
  );
